      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="edit-class-name" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Nom de la classe
              </label>
              <input
                type="text"
            ...
            <div className="mb-6">
              <label htmlFor="edit-class-level" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                Niveau de la classe
              </label>
              <select
                id="edit-class-level"
