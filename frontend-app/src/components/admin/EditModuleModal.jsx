  ...
  useEffect(() => {
    if (module) {
      setFormData({
        ...
        classeId: module.classe?.id || "",
        professeurId: module.professeur?.id || "",
      });
    }
  }, [module]);
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <label htmlFor="edit-module-title" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Titre
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label htmlFor="edit-class-id" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Classe
            </label>
            {isLoadingData ? (
          ...
          <div className="mb-6">
            <label htmlFor="edit-professor-id" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              Professeur
            </label>
            {isLoadingData ? (
              <div className="animate-pulse h-10 bg-gray-200 dark:bg-gray-700 rounded-md"></div>
